<?php
    ...
    if ($conn->connect_error) {
        ...
        $sql = "select overall_rating, defensive_work_rate as xValue from Player_Attributes A join Player B on A.id=B.id where 1";
    ...
    $xVal = ['low'=>1, 'medium'=>2, 'high'=>3];
    $xDesc = [1=>'niska', 2=>'normalna', 3=>'wysoka'];
